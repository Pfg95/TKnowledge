...
public class TKTCResearchItem extends ResearchItem {
	...
	public TKTCResearchItem(String key, String category, String original, String originalCategory, int displayX, int displayY, ResourceLocation icon)
	{
	...
	public TKTCResearchItem(String key, String category, String original, String originalCategory, int displayX, int displayY, ItemStack icon)
	{
		super(key,category,new AspectList(),displayX,displayY,1,icon);
		this.original = ((ResearchCategoryList)ResearchCategories.researchCategories.get(originalCategory)).research.get(original);
		this.setupOriginal();
